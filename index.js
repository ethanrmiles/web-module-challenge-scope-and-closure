...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
      The variable the counter starts at is declared within block scope for counter 1, and within global
      scope in counter 2. 
  2. Which of the two uses a closure? How can you tell?
      Counter 1 includes closure as it contained nested functions, thus drawing references from nearby functions
      as allowed by closure.
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     A scenario where you don't want the variable to be able to be changed by the other code, or if you are trying
     to create privacy. 
*/
